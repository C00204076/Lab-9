...
void Game::initialize()
{
	...
	//
	vertexFile.open("../Files/vertexShaders.txt");
	fragmentFile.open("../Files/fragmentShaders.txt");
	//
	...
	//
	std::string vertexS = vertexSS.str();
	std::string fragmentS = fragmentSS.str();
	//
	const char * sourceVertex = vertexS.c_str();
	const char * sourceFragment = fragmentS.c_str();
	...
	// Back-top triangle
	triangles[6] = 6;	triangles[7] = 4;	triangles[8] = 5;
	// Back-bottom triangle
	triangles[9] = 5;	triangles[10] = 7;	triangles[11] = 6;

	// Right-top triangle
	triangles[12] = 4;	triangles[13] = 2;	triangles[14] = 3;
	// Right-bottom triangle
	triangles[15] = 4;	triangles[16] = 3;	triangles[17] = 6;

	// Left-top triangle
	triangles[18] = 0;	triangles[19] = 5;	triangles[20] = 1;
	// Left-bottom triangle
	triangles[21] = 0;	triangles[22] = 7;	triangles[23] = 5;

	// Top-top triangle
	triangles[24] = 1;	triangles[25] = 4;	triangles[26] = 5;
	// Top-bottom triangle
	triangles[27] = 1;	triangles[28] = 2;	triangles[29] = 4;

	// Bottom-top triangle
	triangles[30] = 0;	triangles[31] = 6;	triangles[32] = 7;
	// Bottom-bottom triangle
	triangles[33] = 0;	triangles[34] = 3;	triangles[35] = 6;
	...
	const char* vs_src = sourceVertex;//"#version 400\n\r"
		//"in vec4 sv_position;"
		//"in vec4 sv_color;"
		//"out vec4 color;"
		//"void main() {"
	...
	const char* fs_src = sourceFragment; //"#version 400\n\r"
		//"in vec4 color;"
		//"out vec4 fColor;"
		//"void main() {"
...
void Game::render()
{
	...
	//glBufferData(GL_ARRAY_BUFFER, sizeof(Vertex) * 6, back, GL_STATIC_DRAW);
